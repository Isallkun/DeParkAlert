    ...
    <section className="py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Real-time monitoring of parking and traffic incidents with AI-powered insights</p>
        </div>
              ...
              <div key={report.id} className="px-6 py-4 hover:bg-card/50 transition flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className={`text-xs px-2 py-1 rounded-full font-medium ${report.severity === "high" ? "bg-red-500/20 text-red-400" : "bg-yellow-500/20 text-yellow-400"}`}>{report.severity.toUpperCase()}</span>
                  </div>
        ...
        <div className="grid md:grid-cols-4 gap-4 mt-8">
          {[
            ...
            <div key={stat.label} className="p-4 rounded-lg border border-border bg-card/30 backdrop-blur-sm text-center">
